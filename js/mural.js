/*
    const cartao = (function(){ 
        ...
        return {
            criar:adicionaCartaoNoMural,
            quantidadeCartoes: numeroDoCartao
        }
    })


    para chamar externamente ===> cartao.adicionaCartaoNoMural(cartao)
*/
...
;(function(){
    ...
    window.adicionaCartaoNoMural = function(cartaoObj){
        numeroDoCartao++;
        const conteudoDoConteudo = cartaoObj.conteudo;
        ...
        <p class="cartao-conteudo" contenteditable tabindex="0">${conteudoDoConteudo}</p>
        </article>`)
